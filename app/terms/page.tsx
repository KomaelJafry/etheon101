...
export default function TermsPage() {
  ...
  const intro = get('legal', 'terms_intro', 'Our full terms of service are being drafted by our legal team. They will cover your rights and obligations as an Etheon platform user.');
