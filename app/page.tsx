      ...
      <div style={{ position: 'relative', zIndex: 2 }}>
        ...
        <section className="landing-hero-grid">
          <div>
            ...
            <div style={{ display: 'flex', gap: '14px', flexWrap: 'wrap' }}>
              ...
              <Link href="/dashboard" style={{ textDecoration: 'none' }}>
                <RippleButton variant="none" style={{ display: 'flex', alignItems: 'center', gap: '8px', height: '54px', padding: '0 26px', borderRadius: '999px', fontSize: '16px', fontWeight: 700, color: '#C9BBFF', background: 'rgba(124,92,255,0.12)', border: '1px solid rgba(124,92,255,0.28)' }}>
                  View dashboard
                </RippleButton>
              </Link>
            </div>
          ...
          <div style={{ position: 'relative' }}>
            <div style={{ position: 'absolute', inset: '-40px', borderRadius: '50%', background: 'radial-gradient(circle,rgba(124,92,255,0.32),transparent 65%)', filter: 'blur(30px)' }} />
            <div style={{ position: 'relative', borderRadius: '28px', padding: '26px', background: 'linear-gradient(165deg,rgba(30,26,48,0.9),rgba(13,12,22,0.95))', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 40px 80px rgba(0,0,0,0.5)', animation: 'etheonFloat 6s ease-in-out infinite' }}>
              ...
              <div style={{ position: 'relative', width: '200px', height: '200px', margin: '0 auto' }}>
                <div style={{ position: 'absolute', inset: '18px', borderRadius: '50%', background: 'radial-gradient(circle,rgba(124,92,255,0.3),transparent 66%)', animation: 'etheonGlowBreathe 4s ease-in-out infinite' }} />
                <svg viewBox="0 0 130 130" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', animation: 'etheonSpin 16s linear infinite', opacity: 0.5 }}>
                  <circle cx="65" cy="65" r="61" fill="none" stroke="rgba(124,92,255,0.45)" strokeWidth="1.2" strokeDasharray="2 9" />
                </svg>
        ...
        <section style={{ background: '#ECEBF4', padding: '0 32px 80px' }}>
          <div style={{ maxWidth: '1180px', margin: '0 auto', position: 'relative', overflow: 'hidden', borderRadius: '32px', padding: '64px 48px', background: 'linear-gradient(135deg,#1a1530,#0B0A14)', border: '1px solid rgba(124,92,255,0.3)' }}>
            <div style={{ position: 'absolute', top: '-60px', right: '-30px', width: '300px', height: '300px', borderRadius: '50%', background: 'radial-gradient(circle,rgba(124,92,255,0.4),transparent 65%)', pointerEvents: 'none' }} />
